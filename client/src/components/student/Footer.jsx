...
const Footer = () => {
  return (
    <footer className="bg-gray-900 md:px-36 text-left w-full mt-10">
      ...
      gap-10 md:gap-32 py-10 border-b border-white/30">
        <div className="flex flex-col md:items-start items-center w-full">
          ...
          <p className="mt-6 text-center md:text-left text-sm text-white/80">Lorem ipsum dolor sit amet consectetur adipisicing elit. 
            Animi cupiditate dolore inventore error quo ipsam esse, deleniti cum facilis aliquam?</p>
        </div>
        <div className="flex flex-col md:items-start items-center w-full">
        ...
        <div className="hidden md:flex flex-col items-start w-full">
          ...
          <p className="text-sm text-white/80">Lorem ipsum dolor sit amet consectetur, adipisicing elit.
             Provident quia deleniti porro unde nihil eum!</p>
      ...
      <p className='py-4 text-center text-xs md:text-sm text-white/60'>Copyright 2026 Sardar Nazeer. All right reserved</p>
    </footer>
  )
}
