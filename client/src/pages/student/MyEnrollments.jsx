    ...
    <tbody className='text-gray-700'>
      {enrolledCourses?.map((course,index) => (
        <tr key={course._id} className="border-b border-gray-500/20">
          <td className="md:px-4 pl-2 md:pl-4 flex items-center space-x-3 px-4 py-3">
          ...
          <td className="px-4 py-3 max-sm:text-right">
            <button onClick={()=> navigate('/player/' + course._id)}
             className="cursor-pointer bg-blue-500 sm:px-5 sm:py-2 max-sm:text-xs text-white px-4 py-1 rounded">
